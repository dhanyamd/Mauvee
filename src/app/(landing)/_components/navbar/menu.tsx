...
const Menu = ({orientation} : MenuProps ) => {
  ...
  switch (orientation) {
    case "desktop" : 
     return (
      <Card className="bg-themeGray border-themeGray bg-clip-padding backdrop--blur__safari backdrop-filter blackdrop-blur-2xl
      bg-opacity-60 p-1 lg:flex hidden rounded-xl ">
